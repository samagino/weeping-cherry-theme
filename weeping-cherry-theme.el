;;; weeping-cherry-theme.el --- Theme 

;; Copyright (C) 2021 , samagino
...
;; a soft light theme, maybe a bit too soft...

;;; Code:

 (deftheme weeping-cherry)
 (let ((class '((class color) (min-colors 89)))
   ...
   'weeping-cherry
	...
	`(cursor ((,class (:background ,cursor))))
        ...
        `(mode-line ((,class (:box (:line-width 1 :color ,bg4) :bold t :foreground ,var :background ,bg2))))
        `(mode-line-inactive ((,class (:box (:line-width 1 :color nil :style pressed-button) :foreground ,fg1 :background ,bg1 :weight normal))))
	...
	`(slime-repl-inputed-output-face ((,class (:foreground ,type))))
        ...
        `(rainbow-delimiters-depth-2-face ((,class :foreground ,var)))
        `(rainbow-delimiters-depth-3-face ((,class :foreground ,const)))
        `(rainbow-delimiters-depth-4-face ((,class :foreground ,type)))
        `(rainbow-delimiters-depth-5-face ((,class :foreground ,keyword)))
        `(rainbow-delimiters-depth-6-face ((,class :foreground ,func)))
        `(rainbow-delimiters-depth-7-face ((,class :foreground ,str)))
        `(rainbow-delimiters-depth-8-face ((,class :foreground ,builtin)))
...
(provide-theme 'weeping-cherry)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; weeping-cherry-theme.el ends here
